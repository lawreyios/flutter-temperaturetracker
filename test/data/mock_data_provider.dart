...
class MockDataProvider {
  LogList getMockLogList() {
    ...
    newLog2.dateTime = new DateTime(2020, 10, 1, 10, 1, 1, 0, 0);
    Log newLog3 = Log(36.7);
    newLog3.dateTime = new DateTime(2020, 10, 1, 10, 2, 1, 0, 0);
    Log newLog4 = Log(36.8);
    newLog4.dateTime = new DateTime(2020, 10, 1, 10, 3, 1, 0, 0);
